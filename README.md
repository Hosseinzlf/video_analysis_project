...
FastAPI service that analyzes videos and returns an **AI-generated description** using Google Gemini. It validates uploads, extracts keyframes (with scene detection), and sends them to Gemini for a text summary.
